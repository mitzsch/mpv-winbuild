...
build() {
    ...
    ninja -C $buildroot/build$bit ffmpeg-ntruehdv2-fullclean 	
    ninja -C $buildroot/build$bit mpv-plex-otruehd-fullclean
    ninja -C $buildroot/build$bit mpv-plex-ntruehd-fullclean
    ninja -C $buildroot/build$bit mpv-plex-ntruehdv2-fullclean
    
    ninja -C $buildroot/build$bit mpv-plex-ntruehdv2
